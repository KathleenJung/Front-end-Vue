      ...
      <b-card class="text-center mt-3 shadow" style="width:70%;" bg-variant="light">
        ...
        <b-form-group class="m-5">
          ...
          <b-form-group label-for="nested-password" label-align-sm="right">
            <b-form-input id="nested-password" placeholder="비밀번호" v-model="user.userPwd"></b-form-input>
          </b-form-group>

          <b-form-group label-for="nested-confirm-password" label-align-sm="right">
            <b-form-input id="nested-confirm-password" placeholder="비밀번호 확인"></b-form-input>
          </b-form-group>

          <b-form inline>
            <b-form-input id="inline-form-input-name" class="mb-2 mr-sm-2 mb-sm-0" placeholder="이메일 아이디"
              v-model="user.emailId">
            </b-form-input>
            <b-input-group prepend="@" class="mb-2 mr-sm-2 mb-sm-0">
              <b-form-input id="inline-form-input-username" placeholder="ssafy.com" v-model="user.emailDomain">
              </b-form-input>
            </b-input-group>
          </b-form>
